...
public class MonScanner {
	...
	public MonScanner(String file) {
		try {
			...
			System.out.println("Avez-vous bien place le fichier a la racine du projet IntelliJ?");
			System.out.println("Pour plus d'info, prenez connaissance du document monScanner.txt (moodle)");
			e.printStackTrace() ;
			System.exit(0);
		}
	}
