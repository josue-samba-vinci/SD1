...
public class TestListeSDImpl {
	...
	private static void testIterateur() {
		...
		System.out.println();
		System.out.println("Test 1 : liste testee : marie pierre hugo sam lea");
		String[] tableTestee1 = {"marie","pierre","hugo","sam","lea"};
		l = new ListeSDImpl<String>(tableTestee1);
		Iterator<String> it = l.iterator();
		if(it==null){
			System.out.println("test 1 ko : avez-vous complete la methode iterator() ?");
			System.exit(0);
		}
		if(!it.hasNext()){
			System.out.println("test 1 ko : 1er appel de la methode hasNext()");
			System.out.println("test 1 ko : attendu : true - recu : false");
			System.out.println("test 1 ko : revoyez le constructeur de la classe interne Iterateur");
			System.out.println("test 1 ko : revoyez la methode hasNext() de la classe interne Iterateur");
			System.exit(0);
		}
		if(it.next()==null){
		...
		System.out.println("Test 1 : via while + next() et hasNext()");
		int i = 0;
		it = l.iterator();
		while (it.hasNext()){
			if(i==tableTestee1.length){
				System.out.println("test 1 ko : le foreach ne s'est pas arrete");
				System.exit(0);
			}
			String s = it.next();
			if(!tableTestee1[i].equals(s)){
				System.out.println("test 1 ko : attendu : "+tableTestee1[i]+ " - recu : "+ s);
				System.exit(0);
			}
			i++;
		...
		try{
			it.next();
			System.out.println("test 1 ko : apres parcours complet, la methode next() doit lever une NoSuchElementException");
			System.exit(0);
		...
		System.out.println("Test 1 : via foreach");
		i = 0;
		for (String s : l
			 ) {
			if(i==tableTestee1.length){
		...
		System.out.println();
		System.out.println("Test 2 : liste vide");
		String[] tableTestee2 = {};
		l = new ListeSDImpl<String>(tableTestee2);
		it = l.iterator();
		if(it==null){
			System.out.println("test 2 ko : avez-vous complete la methode iterator() ?");
			System.exit(0);
		}
		if(it.hasNext()){
			System.out.println("test 2 ko : appel de la methode hasNext()");
			System.out.println("test 2 ko : attendu : false - recu : true");
			System.out.println("test 2 ko : revoyez le constructeur de la classe interne Iterateur");
			System.out.println("test 2 ko : revoyez la methode hasNext() de la classe interne Iterateur");
			System.exit(0);
		}
		try{
			it.next();
			System.out.println("test 2 ko : la liste est vide, la methode next() doit lever une NoSuchElementException");
			System.exit(0);
		...
		System.out.println("Test 2 : via foreach");
		i = 0;
		for (String s : l
		) {
				System.out.println("test 2 ko : le foreach propose un element alors que la liste est vide");
				System.exit(0);
		}
