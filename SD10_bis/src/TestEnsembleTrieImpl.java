...
public class TestEnsembleTrieImpl {
	...
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("4 ->  Tester la methode predecesseur()");
	...
	private static void testContient() {
		System.out.println();
		System.out.println("Test contient() avec l'ensemble de l'enonce");
		EnsembleTrieImpl<String> e = new EnsembleTrieImpl<String>("lea","anouk","zoe","sam","hugo","tim","marie");
		String nom;
		nom = "lea";
		if(!e.contient(nom)){
			System.out.println("Attention, votre methode annonce que l'ensemble ne contient pas "+nom);
			System.out.println("Revoyez votre methode !");
			return;
		}
		nom = "anouk";
		...
		nom = "bob";
		if(e.contient(nom)){
			System.out.println("Attention, votre methode annonce que l'ensemble contient "+nom);
			System.out.println("Revoyez votre methode !");
			return;
		}
		...
		System.out.println();
		System.out.println("Test contient() avec l'ensemble vide");
		EnsembleTrieImpl<String> eVide = new EnsembleTrieImpl<String>();
		nom = "lea";
		if(eVide.contient(nom)){
			System.out.println("Attention, votre methode annonce que l'ensemble vide contient "+nom);
			System.out.println("Revoyez votre methode !");
			return;
		}
	...
	private static void testPredecesseur() {
		System.out.println();
		System.out.println("Test predecesseur() avec l'ABR1 de l'enonce");
		EnsembleTrieImpl<String> e = new EnsembleTrieImpl<String>("lea","anouk","zoe","sam","hugo","tim","marie");
		...
		System.out.println("Tous les tests avec l'ABR1 de l'enonce ont reussi !");
		System.out.println();



		System.out.println("Test predecesseur() avec l'ABR2 de l'enonce");
		e = new EnsembleTrieImpl<String>("anouk","lea","zoe","sam","tim");
		nom = "lea";
		nomPrec = "anouk";
		nomTrouve = e.predecesseur(nom);
		if(nomTrouve==null){
		...
		System.out.println("Tous les tests avec l'ABR2 de l'enonce ont reussi !");
		System.out.println();
