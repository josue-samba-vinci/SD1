//On voudrait que les étudiants soient affichés selon l’ordre alphabétique des noms et pour
//un même nom selon l’ordre alphabétique des prénoms.
//on va utliser une
...
public class GestionEtudiantsViaNom {
    ...
    private static TreeSet<Etudiant> ensembleEtudiants = new TreeSet<>(new ComparateurNom());
