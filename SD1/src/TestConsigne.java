public class TestConsigne {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Dans ce scenario, la consigne comporte 3 casiers.");
        System.out.println("Au depart, tous les casiers sont libres.");
        ...
        System.out.println("test 3 : attribution d'un deuxieme casier avec le mot de passe 'mdp'");
        try {
            numero = consigne.attribuerCasierLibre(String.valueOf("mdp"));
        } catch (Exception e) {
        ...
        System.out.println("test 5 : attribution d'un casier alors que tous les casiers sont occupes");
        try {
        ...
        System.out.println("test 23 : creation d'une consigne de gare avec 0 casier");
        try {
            consigne = new Consigne(0);
        ...
        // Le nombre de casiers doit etre > 0
        System.out.println("test 24 : creation d'une consigne de gare avec -1 casiers");
        try {
            consigne = new Consigne(-1);
            System.out.println("test 24 ko : il fallait lancer une exception de type IllegalArgumentException");
            System.exit(0);
        ...
        System.out.println("test 24 : tous les casiers sont attribues");
